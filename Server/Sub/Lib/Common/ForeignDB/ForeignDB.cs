...
namespace IMS.Server.Sub.Lib.ExternalDB
{
    public class ExternalDB : DbContext
    {
        public ExternalDB() : base("ExternalDB")
        {
            ...
            Database.SetInitializer(new DropCreateDatabaseIfModelChanges<ExternalDB>());
        }
