...
//  Integer		upsBatteryTemperature;		    // UNITS : degress Centigrade		//141020
...
typedef struct _UPSINPUT
{
  ...
  J_UPSINPUTTABLE	upsInputEntry[TABLE_SIZE];
...
//Integer		eti_loadOutputCurrentPeak;		//141020
...
typedef struct _UPSOUTPUT
{
  ...
  J_UPSOUTPUTTABLE	upsOutputEntry[TABLE_SIZE];
...
typedef struct _UPSBYPASS
{
  ...
  J_UPSBYPASSTABLE	upsBypassEntry[TABLE_SIZE];
...
{
  J_UPSINVERTERTABLE eti_inverterOutputEntry[TABLE_SIZE];
