...
void fill_upsTotalStructure()
{
  ...
  upsTotal.upsMimicState.CB4    = m->upsobjects.upscbmc.CBMCCB3;
  upsTotal.upsMimicState.CB4A   = m->upsobjects.upscbmc.CBMCCB4;
  ...
  upsTotal.upsMimicState.MC2A   = m->upsobjects.upscbmc.BSSU;
...
/*
  upsTotal.upsInput.upsInputFrequency1=500+variation;
  upsTotal.upsInput.upsInputVoltage1=2080+variation;
  upsTotal.upsInput.upsInputCurrent1=250+variation;
  upsTotal.upsInput.upsInputTruePower1=500+variation;
  upsTotal.upsInput.upsInputFrequency2=500+variation;
  upsTotal.upsInput.upsInputVoltage2=2080+variation;
  upsTotal.upsInput.upsInputCurrent2=250+variation;
  upsTotal.upsInput.upsInputTruePower2=500+variation;
  upsTotal.upsInput.upsInputFrequency3=500+variation;
  upsTotal.upsInput.upsInputVoltage3=2080+variation;
  upsTotal.upsInput.upsInputCurrent3=250+variation;
  upsTotal.upsInput.upsInputTruePower3=500+variation;
*/
  for(i=0;i<3;i++)
    {
...
//  // --- Load Output Group ---
  ...
  upsTotal.upsOutput.upsOutputFrequency1=500+variation;
  upsTotal.upsOutput.upsOutputVoltage1=1270+variation;
  upsTotal.upsOutput.upsOutputCurrent1=1000+variation;
  upsTotal.upsOutput.upsOutputPower1=500+variation;
  upsTotal.upsOutput.upsOutputPercentLoad1=60+variation;

  upsTotal.upsOutput.upsOutputFrequency2=500+variation;
  upsTotal.upsOutput.upsOutputVoltage2=1270+variation;
  upsTotal.upsOutput.upsOutputCurrent2=1000+variation;
  upsTotal.upsOutput.upsOutputPower2=500+variation;
  upsTotal.upsOutput.upsOutputPercentLoad2=60+variation;

  upsTotal.upsOutput.upsOutputFrequency3=500+variation;
  upsTotal.upsOutput.upsOutputVoltage3=1270+variation;
  upsTotal.upsOutput.upsOutputCurrent3=1000+variation;
  upsTotal.upsOutput.upsOutputPower3=500+variation;
  upsTotal.upsOutput.upsOutputPercentLoad3=60+variation;

  // --- Bypass Group ---
  upsTotal.upsBypass.upsBypassNumLines=3;
  upsTotal.upsBypass.upsBypassFrequency1=500+variation;
  upsTotal.upsBypass.upsBypassVoltage1=2080+variation;
  upsTotal.upsBypass.upsBypassCurrent1=250+variation;
  upsTotal.upsBypass.upsBypassPower1=500+variation;
  upsTotal.upsBypass.upsBypassFrequency2=500+variation;
  upsTotal.upsBypass.upsBypassVoltage2=2080+variation;
  upsTotal.upsBypass.upsBypassCurrent2=250+variation;
  upsTotal.upsBypass.upsBypassPower2=500+variation;
  upsTotal.upsBypass.upsBypassFrequency3=500+variation;
  upsTotal.upsBypass.upsBypassVoltage3=2080+variation;
  upsTotal.upsBypass.upsBypassCurrent3=250+variation;
  upsTotal.upsBypass.upsBypassPower3=500+variation;
/*  for(i=0;i<3;i++)
    {
  ...
  // --- upsInverter ---
  upsTotal.upsInverter.eti_ConverterTemp=45+variation;
  upsTotal.upsInverter.eti_InverterTemp=50+variation;
  upsTotal.upsInverter.eti_BatteryTemp=70+variation;
  upsTotal.upsInverter.eti_DCDCTemp=80+variation;
  upsTotal.upsInverter.eti_ISSUTemp=100+variation;
  upsTotal.upsInverter.eti_InnerTemp=140+variation;

  upsTotal.upsInverter.eti_inverterOutputCurrent1=100+variation;
  upsTotal.upsInverter.eti_inverterOutputFrequency1=500+variation;
  upsTotal.upsInverter.eti_inverterOutputVoltage1=1270+variation;
  upsTotal.upsInverter.eti_inverterOutputCurrent2=100+variation;
  upsTotal.upsInverter.eti_inverterOutputFrequency2=500+variation;
  upsTotal.upsInverter.eti_inverterOutputVoltage2=1270+variation;
  upsTotal.upsInverter.eti_inverterOutputCurrent3=100+variation;
  upsTotal.upsInverter.eti_inverterOutputFrequency3=500+variation;
  upsTotal.upsInverter.eti_inverterOutputVoltage3=1270+variation;
