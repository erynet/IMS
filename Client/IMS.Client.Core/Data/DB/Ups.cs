                    ...
                    if (ascending)
                        return (from u in ctx.Ups
                                ...
                                select new Ups.Info()
                                {
                                    ...
                                    upsNo = u.No,
                                    groupIdx = u.GroupIdx,
                                    groupNo = (from g in groupTotal where g.Idx == u.GroupIdx select g.No).DefaultIfEmpty(0).First(),
                                    upsName = u.Name,
                                    ...
                                    cduIdx = (from c in cduTotal where c.Idx == u.CduNo select c.Idx).DefaultIfEmpty(0).First(),
                                    cduNo = u.CduNo,
